...
public class WeekInfo {
    ...
    public void setData(WeekData[] data) {
        this.data = data;
    }
    ...
    public class WeekData {
        ...
        public WeekData(int type, String timestamp, int max_speed, int avg_speed, int max_rise, int avg_rise, int calorie, int odometer, int elapse, int max_hr, int avg_hr, int max_rev, int avg_rev, int max_res, int avg_res, int max_watt, int avg_watt) {
            this.type = type;
